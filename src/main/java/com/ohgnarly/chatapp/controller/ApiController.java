...
public class ApiController {
    ...
    public ResponseEntity<List<Message>> getMessages(@RequestParam(required = false) Integer pageNumber) throws ChatException {
        pageNumber = isNull(pageNumber) ? 0 : pageNumber;
        List<Message> messages = this.apiService.getMessages(pageNumber);
